...
> 회원가입, 로그아웃, 회원탈퇴, 게시판 글쓰기,글 조회하기, 글 수정하기, 글 삭제하기, 예금하기, 출금하기, 송금하기를 구현했습니다.

> main.go:160,189, 236,300,339,377, 사용자 이메일, 전화번호의 노출을 막기 위해 사용자정보가 포함된 로그를 지웠습니다. 

> main.go 외에 user 디렉토리와 banking 디렉토리와 post 디렉토리를 만들어 다음과 같이 분리하여 관리하면 좋을 것 같습니다. 
> user 디렉토리: 로그인, 회원가입, 회원탈퇴 로직
> banking 디렉토리: 예금하기, 출금하기, 송금하기 로직
> post 디렉토리: 게시판 글쓰기,글 조회하기, 글 수정하기, 글 삭제하기 로직
